...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(I2C3_SCL_OLED_GPIO_Port, I2C3_SCL_OLED_Pin, (GPIO_PinState)BitValue);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(I2C3_SDA_OLED_GPIO_Port, I2C3_SDA_OLED_Pin, (GPIO_PinState)BitValue);
	/*如果单片机速度过快，可在此添加适量延时，以避免超出I2C通信的最大速度*/
	//...
}
